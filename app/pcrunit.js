...
pcrunit.PC_UNIT_INFO_LIST = [
  ...
  [
    ...
    ['pecorine_astraia', 'ペコリーヌ(アストライア)', './img/arena/ペコリーヌ(アストライア).jpg', true],
    ...
    ['quria_valkyria', 'クリア(ヴァルキュリア)', './img/arena/クリア(ヴァルキュリア).jpg', true],
    ...
    ['violet_isanami', 'ヴァイオレット(イサナミ)', './img/arena/ヴァイオレット(イサナミ).jpg', true],
  ...
  [
    ...
    ['riri_valkyria', 'リリ(ヴァルキュリア)', './img/arena/リリ(ヴァルキュリア).jpg', true],
    ...
    ['wakana_winter', 'ワカナ(ウィンター)', './img/arena/ワカナ(ウィンター).jpg', true],
  ...
  [
    ...
    ['louisemarie_summer', 'ルイズマリー(サマー)', './img/arena/ルイズマリー(サマー).jpg', true],
    ...
    ['kyouka_gothic', 'キョウカ(ゴシック)', './img/arena/キョウカ(ゴシック).jpg', true],
...
pcrunit.NPC_UNIT_INFO_LIST = [
  ...
  [
    ...
    ['locusfortress', 'ロクス・フォートレス', './img/clanbattle/ロクス・フォートレス.jpg', true],
  ...
  [
    ...
    ['goblinsorcerer', 'ゴブリンソーサラー', './img/clanbattle/ゴブリンソーサラー.jpg', true],
